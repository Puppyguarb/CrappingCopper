...
public class ModArmor {
    ...
    public static void register() {
        if (Main.SETTINGS.enableCompressedCopper) {
            if (Main.SETTINGS.enableCompressedCopperArmor) {
                //Compressed armor.
            ...
            if (Main.SETTINGS.enableHyperDenseCopper) {
                if (Main.SETTINGS.enableHyperDenseCopperArmor) {
                    //Hyper armor.
                ...
                if (Main.SETTINGS.enableTranscendedCopper && Main.SETTINGS.enableTranscendedCopperArmor) {
                    //Transcended armor.
